...
# RHBFWebhook
[Rusher utility mod](https://rusherhack.org/) (Minecraft Java 1.12.2 paid utility mod, [Base Finder Module](https://rusherhack.org/features/basefinder.html), Webhook (discord webhook) is a tool that utilizes the log file of basefinder to send messages to a discord webhook that 
