...
# RHBFWebhook
Rusher utility mod (Minecraft Java 1.12.2 paid utility mod [(link)](https://rusherhack.org/), [Base Finder Module](https://rusherhack.org/features/basefinder.html), Webhook (discord webhook) is a tool that utilizes the log file of basefinder to send messages to a discord webhook that 
